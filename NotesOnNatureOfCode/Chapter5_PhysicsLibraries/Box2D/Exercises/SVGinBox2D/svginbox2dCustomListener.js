...
class CustomListener {
  ...
  BeginContact(contact) { // Notice that this function includes an argument of type 'contact'. A Contact object
    ...
    // If a particle touches the wall
    if (object1 instanceof Particle && object2 instanceof ChainShape) {
      object1.applyBounce();
    } else if (object2 instanceof Particle && object1 instanceof ChainShape) {
      object2.applyBounce();
    }
  }
